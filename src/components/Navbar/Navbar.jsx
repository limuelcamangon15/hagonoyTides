...
function Navbar() {
  ...
  return (
    <>
      <nav
        className={`flex flex-row backdrop-blur-md bg-white/25 justify-between items-center z-10 fixed top-2 p-2 w-[98%] rounded-3xl h-fit transition-all duration-700 ease-in-out ${
