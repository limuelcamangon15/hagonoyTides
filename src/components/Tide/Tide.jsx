...
function Tide({ tide: { date, day, isoDate, tide }, dateIndex }) {
    ...
    return (
        <>
            <div className={`flex flex-col min-w-[50%] h-full ${new Date().getDate() == date && new Date().getMonth() == dateIndex ? `bg-[#0E2DA6]/30` : `bg-[#D9D9D9]/30`} border border-white  rounded-xl custom-inner-shadow relative`}>
